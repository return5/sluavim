...
_ENV = Input
 ...
 Input.i = 1
 Input.chars = {'i','h','e','l','l','o','W','O','R','L','D',KeyMapings.ESC,'o','j','k','L',KeyMapings.ESC,'k','o','g','h','t'}--,'j','u','r','k','j','u','m','p',KeyMapings.ESC}--,'q','a','F','u','y','$',KeyMapings.ESC,'q','@','a'}--'t',KeyMapings.ESC,'q','h','@','e'}
