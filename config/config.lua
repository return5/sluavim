...
return {
	...
	enableColor = true,
	easyMode = false,
	--color pairs: numberOfColorPair = name, foreground color, background color
	colorPairs = {
		COLOR_BLACK = {"COLOR_BLACK","COLOR_BLACK","COLOR_BLACK"},
		COLOR_RED = {"COLOR_RED","COLOR_RED","COLOR_BLACK"},
		COLOR_GREEN = {"COLOR_GREEN","COLOR_GREEN","COLOR_BLACK"},
		COLOR_YELLOW = {"COLOR_YELLOW","COLOR_YELLOW","COLOR_BLACK"},
		COLOR_BLUE = {"COLOR_BLUE","COLOR_BLUE","COLOR_BLACK"},
		COLOR_MAGENTA = {"COLOR_MAGENTA","COLOR_MAGENTA","COLOR_BLACK"},
